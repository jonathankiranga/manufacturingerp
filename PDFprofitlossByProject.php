...
$reportnames = array();
$reportnames['EXEC [dbo].[Profit_loss]']="INCOME STATEMENT BY PROJECT :".$_SESSION['Dimesion_two'][$_POST['DimensionTwo']];
...
function original(){
    ...
    $headerName = $reportnames['EXEC [dbo].[Profit_loss]'];
    $PaperSize='A4';
    include('includes/PDFStarter.php');
    ...
    include('includes/PDFpandlheader.inc');
     ...
     $amount   = 0;
     $lastYear = 0;
     DB_Profit_loss_Project();
     
     $ResultsX = DB_query("EXEC [dbo].[DB_Profit_loss_Project] ",$db);
