...
$reportnames = array();
$reportnames['EXEC [dbo].[AccountBalance]'] = "Trail Balance";
$reportnames['EXEC [dbo].[Profit_loss]'] = "Trading Profit and Loss";
$reportnames['EXEC [dbo].[Balancesheet]'] = "Balance Sheet";
