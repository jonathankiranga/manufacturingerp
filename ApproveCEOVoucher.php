...
if(isset($_POST['approve'])){
    $SQL=sprintf("Update paymentvoucherheader set [status]='2',[Comments]='%s' where [journal]='%s'",$_POST['comments'],$_POST['pvjounal']);
    DB_query($SQL,$db);
...
. '<tr><td colspan="4">Comments: <textarea  rows="2" cols="50" name="comments"></textarea></td></tr></table></td></tr>'
. '<tr>';

echo  '<td colspan="3"><input type="submit" name="approve" value="Approve Payment Voucher" onclick="return confirm(\''._('Do you want to approve this Payment Voucher ?').'\');" />';
