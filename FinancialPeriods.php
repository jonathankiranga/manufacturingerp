...
If(isset($_POST['CloseMonth'])){
    ...
    DB_query("UPDATE companies set [PeriodRollover]=DATEADD(M,1,[PeriodRollover]) WHERE coycode=1",$db);
...
$ForceConfigReload = False;
  ...
  $ResultIndex=DB_query("SELECT top 12 [start_date],[end_date],[Name],[newyear],[closed],[periodno]  
 FROM [FinancialPeriods] order by start_date desc", $db);
