...
function Ageing($custid,$period){
 ...
 $SQL="EXEC [dbo].[ageingSuppliersReport] @account ='".$custid."',@Month ='".$period."'";
 $ResultIndex = DB_query($SQL,$db);
 $agerow = DB_fetch_row($ResultIndex);
 
 $ageingarray[0]=(float) $agerow[0];
 $ageingarray[1]=(float) $agerow[1];
 $ageingarray[2]=(float) $agerow[2];
 $ageingarray[3]=(float) $agerow[3];
 $ageingarray[4]=(float) $agerow[4];
