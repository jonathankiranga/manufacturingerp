...
echo '<tr>';
 ...
 echo '</tr>';
       ...
       $sql="SELECT 
        ...
        (isnull((SELECT sum([amount]) FROM [PaymentsAllocation]   where [receiptjournal]='".$selectedrec."'),0)) as Tamount
        ,(isnull((SELECT sum([amount]) FROM [PaymentsAllocation]  where [journalno]='".$selectedrec."'),0)) -  
        (isnull((SELECT sum([amount]) FROM [PaymentsAllocation]   where [receiptjournal]='".$selectedrec."'),0)) as Pamount
